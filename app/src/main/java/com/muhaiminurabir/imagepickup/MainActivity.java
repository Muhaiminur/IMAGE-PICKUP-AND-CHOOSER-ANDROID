...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.btn_choose_image2)
    Button btnChooseImage2;
    ...
    private static File getOutputMediaFile() {
        ...
        location = mediaFile.getAbsolutePath();
        return mediaFile;
    }

    @OnClick(R.id.btn_choose_image2)
    public void onViewClicked() {
        EasyImage.openChooserWithGallery(MainActivity.this, "ABIR", 0);
    }
}
